...
- 대신 [Local Research Notes]와 첨부된 사진에 있는 **구체적인 명사(Concrete Nouns)**를
  ...
  * ✅ GOOD: "잉어 연못(koi pond)이 있는 고즈넉한 다이닝 공간과 매콤한 마파두부 요리"
...
스키마 (정확히 이 6 개 키):
{{
  "_internal_monologue": "<추상적인 형용사('아름다운', '특별한')를 버리고, Research Notes에서 어떤 **구체적인 팩트와 명사**(예: 연못, 사과 턴오버, 샹티이 크림, 주차 공간 몇 대)를 슬라이드에 사용할 것인지 2~3문장으로 브리핑해라.>",
  "carousel_ko": [
    {{
      "slide_number": 1,
