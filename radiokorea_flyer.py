...
MART_CREATIVE_PROMPT = (
    ...
    "받아서 정확히 '15초'에 딱 떨어지는 초압축 미친 텐션 대본을 만들어.\n\n"
    "🚨 [길이 및 내용 제한 - 15초 절대 엄수]\n"
    "1. 대본은 무조건 **3~4문장 이내, 총 80자 이내**로 극단적으로 짧게 써.\n"
    "2. 데이터에 상품이 5개가 있어도 절대 다 말하지 마! 가장 파격적인 **메인 상품 딱 1개(많아야 2개)**만 소리치고 나머지는 과감히 버려.\n"
    "3. 구구절절 설명할 시간 없어! 바로 가격 지르고 앱 다운로드로 넘어가.\n\n"
    "🚨 [톤앤매너]\n"
    "1. 아주 다급한 '긴급 속보'나 '라이브 방송' 느낌으로 시작해.\n"
    "2. '이 가격 실화냐?', '지갑 털린다', '차 키 챙겨' 같은 멘트를 섞어.\n"
    "3. 초성(ㅋㅋ, ㄷㄷ) 금지. 물결표(~) 없이 깔끔한 구어체 문장으로 맺어.\n\n"
    "🚨 [출력 형식]\n"
    "반드시 아래 평문 텍스트 양식을 칼같이 지켜서 응답해. JSON 형식은 절대 사용하지 마.\n\n"
    "=== 대본 ===\n"
    "[성우가 숨도 안 쉬고 15초 안에 읽을 극단적으로 짧은 대본]\n\n"
    "=== 씬 정보 ===\n"
