...
{{
  ...
  "feedback": "<반드시 아래 형식을 지켜라: (1) 어느 섹션이 문제인지 정확히 명시 (예: [🇰🇷 KO Carousel] Slide 2, 또는 [🇺🇸 Reddit Promo]). (2) 문제가 된 '나쁜 문장'을 원문 그대로 인용. (3) 그 자리에 넣을 수 있는 '좋은 문장'을 local insider 톤으로 직접 제시. 예시 형식: '[🇺🇸 EN Carousel] Slide 3 — BAD: \"Don't miss this amazing experience!\" → GOOD: \"Parking is a nightmare but I've been back four times, make of that what you will.\"' 섹션 특정 없이 막연한 '광고 냄새 난다' 식 피드백은 쓰지 마라.>",
