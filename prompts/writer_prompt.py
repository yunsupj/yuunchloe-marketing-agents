...
🎯 **핵심 톤 기준** (KO/EN 공통):
  (a) [Persona]와 [Tone]이 최우선이다 — 아래 기준보다 항상 위에 있다.
  (b) 그 동네를 잘 아는 로컬 매거진 에디터가 직접 발로 뛰며 쓴 세련된 로컬 가이드 느낌.
  (c) 과장·감탄·슬랭 없이, 구체적인 사실과 분위기로 독자를 끌어들인다.
**절대로** 기업 SNS 매니저, 광고 카피라이터, 푸드 블로거의 글처럼 들리면 안 된다.
Refined, hyper-local, informative, aesthetic — 이 네 단어가 모든 슬라이드의 기준이다.
